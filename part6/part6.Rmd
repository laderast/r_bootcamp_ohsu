...
For example, say that you have multiple files that have the same format and you want to load them all into R, and glue them into a dataset. 
...
We might have a list of objects where one of the elements is *faulty*. Maybe there's no data in it.

...
- **Learn** and **apply** date manipulation functions in `lubridate`
- **Learn** about functions and how to write them
- **Learn** about for-loops and how to repeat operations using them
...
What about when someone tries `square_number("two")`? Since "two" is a character, you can't multiply with it.

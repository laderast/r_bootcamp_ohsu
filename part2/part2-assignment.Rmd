...
1.  Load the `data/smoke_complete.xlsx` file into R using `read_excel`. You'll need to take a look at it to make sure that your arguments are correct (2 points).
...
3. Use `skim()` on `smoke_complete()`.  Is the `year_of_death` variable skewed or not? Describe how it is skewed.

---
title: "Ready for R Part 1: Functions and objects"
author: "Your Name"
...
## Introduction to the Ready for R course

To get started, start playing the video below. If there's no video, click on the green play button in the box below.

Direct link to video: https://youtu.be/Q0tMCuHbIkw

```{r}
vembedr::embed_youtube("Q0tMCuHbIkw", width = 600, height=300)

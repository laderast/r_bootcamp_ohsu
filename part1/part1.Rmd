...
Part 1 focuses on working through common tasks in data science: importing, wrangling, visualizing, and modeling data. Throughout, we'll work on concepts of reproducibility by utilizing project-based workflows and RMarkdown as a way of reproducibly sharing our work.

Part 2 focuses on more advanced topics: automating analyses using metadata, machine learning using `tidymodels`, using Git/GitHub, and an introduction to Bioconductor for bioinformatics analysis.
...
We will select a number of datasets to work with. You are encouraged to work together, but 
